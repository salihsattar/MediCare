...
if (!isset($_SESSION['user_id'])) { ?>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Hi, <?php echo htmlspecialchars($_SESSION['full_name']); ?></h1>
            <nav aria-label="breadcrumb animated slideInDown">
    
            <a href="logout.php" class="btn btn-sm btn-outline-dark btn-light ms-2 ml-3" style="padding: 2px 8px; font-size: 13px;">
